      ...
      child: MouseRegion(
        ...
        child: AnimatedDefaultTextStyle(
          ...
          style: isSelected
              ...
              : GoogleFonts.oswald(
                  color: widget.color ?? Colors.black, fontSize: 23.0),
      ...
      child: MouseRegion(
        ...
        child: AnimatedDefaultTextStyle(
          ...
          style: isSelected
              ...
              : GoogleFonts.oswald(
                  color: widget.color ?? Colors.blueAccent, fontSize: 23.0),
          child: Text(widget.title),
        ),
      ),
    );
...
class AddDataFireStore {
  ...
  Future<bool> addResponse(final firstName, final lastName, final email,
      final phoneNumber, message) async {
...
Future DialogError(BuildContext context, String title) {
  return showDialog(
      context: context,
      builder: (BuildContext contexct) => AlertDialog(
